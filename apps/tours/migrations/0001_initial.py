    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('includes', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='شامل')),
                ('excludes', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='شامل نمی\u200cشود')),
                ('itinerary', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='برنامه سفر')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tours', to='tours.tourcategory', verbose_name='دسته\u200cبندی')),
            ],
            options={
                'verbose_name': 'تور',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(default=0, verbose_name='ترتیب')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ایجاد')),
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='tours.tour', verbose_name='تور')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='tour',
            name='gallery',
            field=models.ManyToManyField(blank=True, related_name='tour_galleries', to='tours.tourimage', verbose_name='گالری تصاویر'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='tours.tour', verbose_name='تور')),
            ],
            options={
